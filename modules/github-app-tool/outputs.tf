...
output "credential_broker_function_name" { value = aws_lambda_function.broker.function_name }
output "credential_broker_function_arn" { value = aws_lambda_function.broker.arn }
