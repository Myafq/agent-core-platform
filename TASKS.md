...
| HARNESS-003 | IN_PROGRESS | HARNESS-002 | Add the native coding workspace | The immutable ARM64 coding image `github-app-tool-coding@sha256:455de191c7d1339fb4124c8570cd71b3b4bda14223c2ecd8bbce41dc2c658d3b` is deployed on Harness v14. On 2026-08-03, the new workspace unit init/validate/plan passed: 23 creates, no change/destroy, for a two-AZ private VPC, one dev NAT, encrypted backed-up EFS, access point, mount targets, and scoped security groups. Before workspace state exists, the Harness validates and has a structural mock plan (one IAM policy update and one environment update); mock plans are never applied. After workspace apply, replan it with real outputs before applying its EFS/VPC attachment. Then prove clone, edit, test, commit, push, and PR in one Harness session. |
