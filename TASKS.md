...
| HARNESS-003 | IN_PROGRESS | HARNESS-002 | Add the native coding workspace | The immutable ARM64 coding image `github-app-tool-coding@sha256:455de191c7d1339fb4124c8570cd71b3b4bda14223c2ecd8bbce41dc2c658d3b` is published and bound in the Harness composition. On 2026-08-03, `terragrunt init`, `validate`, and the reviewed plan passed: two in-place updates only—Harness environment/allow-list and repository-scoped private-ECR pull policy. Apply remains pending. Then create EFS/VPC/NAT resources, mount EFS at `/mnt/workspace`, and prove clone, edit, test, commit, push, and PR in one Harness session. |
